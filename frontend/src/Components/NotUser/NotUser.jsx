...
const NotUser = ({status}) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1a1a1a] relative overflow-hidden px-4">
      {/* Ambient Glows */}
      ...
      >
        <div className="relative bg-[#232323]/60 backdrop-blur-xl rounded-3xl p-10 text-center border border-white/10 shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
          {/* Inner Glow */}
          <div className="absolute inset-0 rounded-3xl border border-white/5 pointer-events-none" />

          {/* Icon */}
          <div className="flex justify-center mb-6">
            <div className="bg-gradient-to-tr from-red-500 to-yellow-400 w-16 h-16 rounded-full flex items-center justify-center shadow-lg">
          ...
          <p className="text-gray-400 mt-4 text-sm">
            ...
            <span className="text-indigo-400">support@classvault.com</span>
          </p>
        </div>
      </div>
    </div>
